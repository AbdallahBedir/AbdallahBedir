            ...
            <Box>
                <Grid container className={classes.container}>
                    <Grid item className={classes.item} sm={6} xs={12}>
                        <Typography variant="overline" className={classes.overline}>WHO Am I ?</Typography>
                        <Typography variant="body2" className={classes.body2}>
                            I make it my goal to look not only to my own interests, but also to the interests of others. 
                            I am always looking forward to taking care of the details and produce a product free of errors or any bugs.                            
                        </Typography>
                    </Grid>
                    <Grid item className={classes.item} sm={6} xs={12}>
                        <Typography variant="overline" className={classes.overline}>ROUMING OUTSIDE THE BOX</Typography>
                        <Typography variant="body2" className={classes.body2}>
